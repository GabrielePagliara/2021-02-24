...
public class PremierLeagueDAO {
	...
	public List<Player> getAllVertices(Match m, Map<Integer, Player> idMap) {
		String sql = "SELECT a.PlayerID " + "FROM actions a " + "WHERE a.MatchID = ? ";
	...
	public List<Adiacenza> getAdiacenze(Match m, Map<Integer, Player> idMap){
		...
		try {
			...
			while (res.next()) {
				if (idMap.containsKey(res.getInt("p1")) && idMap.containsKey(res.getInt("p1"))) {
